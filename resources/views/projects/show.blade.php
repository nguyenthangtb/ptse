...
@section('content')
    <!-- Breadcrumb -->
    <nav class="hidden lg:block bg-white py-4 md:py-3 mt-[72px] md:mt-[116px] border-b">
                ...
                <ol role="list" class="flex items-center space-x-1.5 md:space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('projects.index') }}" class="ml-1 md:ml-4 text-xs md:text-sm font-medium text-gray-500 hover:text-gray-700">Dự án</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 md:ml-4 text-xs md:text-sm font-medium text-gray-500 truncate max-w-[120px] md:max-w-[200px] lg:max-w-[300px]" aria-current="page" title="{{ $project->title }}">{{ $project->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
