                    ...
                    <article class="bg-white rounded-lg shadow-sm overflow-hidden">
                        @if($service->image)
                            <div class="aspect-video w-full">
                                <img src="{{ Storage::url($service->images) }}" alt="{{ $service->title }}"
                                    class="w-full h-full object-cover">
                            </div>
                        @endif
                        <div class="p-6">
                            <h1 class="text-3xl font-bold mb-4 text-gray-900">{{ $service->title }}</h1>
                            <div class="flex items-center gap-4 text-sm text-gray-600 mb-8 border-b border-gray-100 pb-6">
                                ...
                                <span class="flex items-center">
                                    ...
                                    <span>{{ __('common.number_views') }}: {{ $service->views ?? 0 }}</span>
                                </span>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                        ...
                        <div class="space-y-6">
                            @foreach($recentServices as $item)
                                <div class="group">
                                    <a href="{{ route('services.show', $item) }}" class="flex gap-4">
                                        @if($item->image)
