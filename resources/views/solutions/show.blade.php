                ...
                <ol role="list" class="flex items-center space-x-2 md:space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('solutions.index') }}" class="ml-2 md:ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Giải pháp</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 md:ml-4 text-sm font-medium text-gray-500 truncate max-w-[200px] md:max-w-none" aria-current="page">{{ $solution->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
